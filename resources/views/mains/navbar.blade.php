<div class="navbar">
                <div class="navbar-inner container">
                    ...
                    <div class="logo-box">
                        <a href="index.html" class="logo-text"><span>Mommzi</span></a>
                    </div><!-- Logo Box -->
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-list" role="menu">
                                        ...
                                        <li role="presentation"><a href="{{route('register')}}"><i class="fa fa-lock"></i>Register</a></li>
                                        <li role="presentation"><a href="{{url('/')}}"><i class="fa fa-sign-out m-r-xs"></i>Log out</a></li>
                                    </ul>
