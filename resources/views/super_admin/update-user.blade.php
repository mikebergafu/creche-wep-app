...
<div class="page-inner">
                ...
                @endif
                                    ...
                                    <form method="POST" class="form-horizontal"  action="{{route('user.update',$user[0]->id) }}">
                                    {{ csrf_field() }}
                                    {{ method_field('PUT') }}
                                    ...
                                    <!-- <form class="form-horizontal"> -->
                                     ...
                                     <div class="form-group{{ $errors->has('fullname') ? ' has-error' : '' }}">
                                       ...
                                       <div class="col-sm-10">
                                        <input id="fullname" type="text" class="form-control" name="fullname" value="{{$user[0]->fullname}}" required autofocus>
                                    ...
                                    <div class="form-group{{ $errors->has('position') ? ' has-error' : '' }}">
                                        <label for="name" class="col-sm-2 control-label">Position</label>
                                         ...
                                         <div class="col-sm-10">
                                         <input id="position" type="text" class="form-control" name="position" value="{{ $user[0]->position }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('role') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-10">
                                ...
                                <select id="role" class="form-control" name="role">
                                    <option selected="selected" value="{{$user[0]->role}}">{{$user[0]->role}}</option>
